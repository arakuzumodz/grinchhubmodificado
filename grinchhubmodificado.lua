--normalmente o script é carregado da seguinte forma:
--loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Blackout4781/src/main/ff"))()
--caso o github caia, é só reupar esse arquivo aqui (grinch hub ARQUIVO PRINCIPAL) e carregá-lo como no formato acima
...
local window = library:CreateWindow("Grinch Ware | MODIFICADO", Enum.KeyCode.RightControl)
local Watermark = library:CreateWatermark("Grinch Ware | MODIFICADO | {fps}")
...
getgenv().Distance = 5
Settings:AddSlider("Farm Distance", 5, 7.5, 20, 1, function(self)
